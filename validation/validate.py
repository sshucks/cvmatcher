...
applicants = pd.read_csv("data/validation_data/combined_validation_data.csv")
...
results.to_csv("data/validation_data/validation_results/LLMParsed_GermanBERT.csv", index=False)
