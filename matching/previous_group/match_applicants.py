...
def calculate_score(applicant_data, requirements_data, work_weight, skill_weight, personal_weight, education_weight):
    ...
    # personal_information = get_personal_information(applicant_data)
...
def match_applicant(cv_data, requirements, work_weight, skill_weight, personal_weight, education_weight):
    ...
    position_name, skill_list, personal_skills_list, qualification_list, education_requirements = requirements

    requirements_data = calculate_requirement_embeddings(position_name, skill_list, personal_skills_list, qualification_list, education_requirements)

    score = calculate_score(cv_data, requirements_data, work_weight, skill_weight, personal_weight, education_weight)
